...
import StudentExams from "@/components/StudentExam"
import StudentPerformance from "@/components/StudentPerformance"
import StudentCalendar from "@/components/StudentCalendar"
import StudentMidDayMeal from "@/components/StudentMidDayMeal"
...
import ContentCurriculum from "@/components/ContentCurriculum "
import FeedbackGrievances from "@/components/FeedbackGrievances"
...
export default function Dashboard() {
    ...
    const SidebarContent = ({ onItemClick }: { onItemClick?: () => void }) => (
        <div className="flex flex-col h-full bg-white">
            ...
            <div
                onClick={() => router.push("/")}
                className="p-6 border-b border-blue-100 bg-blue-50/30 backdrop-blur-md cursor-pointer"
            >
